...
class MapaCacic:
    ...
    def encripta(self, text):
        """ Retorna o texto encriptado caso a encriptacao esteja habilitada """
    ...
    def __parseAuthReply__(self, xmlstr):
        ...
        for no in root.childNodes:
            if no.nodeName == "ID_USUARIO":
                ...
                raise Exception("O servidor requer a versao %s do coletor patrimonial.\nSua versao: %s" % (self.decripta(no.firstChild.nodeValue), self.versao_atual))
    ...
    def save(self, dict):
        ...
        self.dicionario['te_localizacao_complementar'] = 'Dataprev/UDSL-ES'
