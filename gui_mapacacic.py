...
class GUIMapaCacic:
    ...
    def __init__(self, mc):
        ...
        self.TITLE = 'MapaCACIC - Módulo Avulso para Coleta de Informacoes Patrimoniais'
        self.selected1 = None
    ...
    def show(self):
        ...
        try:
            ...
            import traceback
            traceback.print_exc()
            self.showAlert("Alguns valores recebidos estao desatualizados e foram descartados")
    ...
    def on_button1_clicked(self, widget):
        ...
        if self.mc.save(valores):
            self.showInfo("Informacoes enviadas com sucesso!")
            gtk.main_quit()
        else:
            self.showAlert("Falha no envio das informacoes")
            gtk.main_quit()
        

class GUIMapaCacicAuth:
    """ 
        Classe de interface gráfica para o MapaCACIC - Coletor Avulso de Informacoes Patrimoniais
    """
    ...
    def on_buttonOk_clicked(self, widget):
        ...
        try:
            ...
            try:
                ...
                pass
            self.showAlert("Erro na comunicacao.\nDetalhes: %s " % e)
            gtk.main_quit()
